  ...
  Search.prototype.render = function (decorated) {
    var $search = $(
      '<li class="select2-search select2-search--inline">' +
        '<input class="select2-search__field" type="search" tabindex="-1" placeholder="Recherche..."' +
          ' role="textbox" />' +
      '</li>'
    );
...
define('select2/i18n/en',[],function () {
	  ...
	  return {
	    inputTooLong: function (args) {
	      ...
	      var message = 'Supprimez " + n + " caractere';
	    ...
	    inputTooShort: function (args) {
	      ...
	      var message = 'Saisissez " + n + " caractere';
	    ...
	    loadingMore: function () {
	      return 'Chargement de resultats supplementaires�';
	    },
	    maximumSelection: function (args) {
	      var message = 'Vous pouvez seulement selectionner ' +
	        args.maximum + ' element';
