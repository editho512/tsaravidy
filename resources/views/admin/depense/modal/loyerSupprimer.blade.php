...
<form action="{{route('loyer.delete' , ['loyer' => $loyer->id])}}" role="form" id="form-supprimer-loyer" method="POST">
    @csrf
    <div class="card-body">
        <div class="form-group">
            <label for="montant">Montant:</label>
            <input type="text" name="montant" class="form-control" id="montant" placeholder="Montant" value='{{$loyer->montant}}' disabled>
        </div>
        <div class="form-group">
                    @php
