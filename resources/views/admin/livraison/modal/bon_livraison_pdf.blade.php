...
@page { margin: 0px; margin-left: 15px;margin-right: 40px; }

h1, h2 , h3, h4, h5 , h6  , .montserrat , p{
...
.bon table , .bon td , .bon th{
 ...
 <div class="row" style="margin-top: 2%">
     <div class="col-xs-2">
         <img src="{{ url('/assets/images/logo/logo-second.png') }}" alt="IMG" style="max-width:260px;max-height:125px;">
     </div>
     <div class="col-xs-10">
 ...
 <div class="row " style="margin-top:3%">
     <div class="col-xs-5" >
       <span  style="display:block;font-size:90%" >Adresse : {{isset($info->adresse) ? $info->adresse : 'Rue de commerce Ampasiamazava'}}</span>
       <span style="display:block;font-size:90%">Tel : {{isset($info->telephone) ? $info->telephone : '+261 32 71 979 15'}}</span>
       <span style="display:block;font-size:90%">Email : {{isset($info->email) ? $info->email : 'hismaljee@gmail.com'}}</span>
       <h6 > <span style="font-weight: bold;border-bottom:solid 1px black;" >Coordonnées</span></h6>
       <span style="display:block;font-size:90%" >NIF : {{isset($info->nif) ? $info->nif : '123 456 789 0258'}}</span>
       <span style="display:block;font-size:90%" >STAT : {{isset($info->stat) ? $info->stat : '987 654 321'}}</span>
       <span style="display:block;font-size:90%" >RCS : {{isset($info->rcs) ? $info->rcs : '028546'}}</span>
         
     </div>
     <div class="col-xs-6" style="padding-top:5% !important;">
      <h4 class="">BON DE LIVRAISON N°: {{$livraisons[0]->numero_bl}}</h4>
      <span style="display:block;margin-bottom:2% !important;" class="mb-2" >Doit:</span>
      <div class="" style="border:solid 1px black;border-radius:5px;margin-right:5px !important;padding:2%">
        <h5 class="mt-2">{{$client[0]->user}}</h5>
        <span style="display:block;" class="mt-4">Email : </span>
        <span class="mt-2">Tél : </span>
      </div>
 ...
 <div class="row" style="margin-left: 2px; ">
     <div class="col-xs-12 bon" style="padding:3px; border-radius:5px; border:solid 1px black;" >
 ...
 <div class="row " style="margin-top:2%;margin-left: 2px;padding:3px; border-radius:5px; border:solid 1px black;">
     <div class="col-xs-12 bon" style="padding:0px !important;">
